                    ...
                    <div class="signup-form">
                        <form action="" class="mt-5 border p-4 bg-light shadow" id="form">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                    <label for="fotoTerbaru" class="">Pas Foto Terbaru<span class="text-danger">*</label>
                                        <input type="file" accept="image/*" capture="camera" class="form-control" name="upload_foto"
                                        id="fotoTerbaru" required autofocus />
                                </div>
                                <div class="mb-3 col-md-12">
                                    <label for="proposalMagang" class="">Proposal Magang<span class="text-danger">*</label>
                                        <input type="file" class="form-control" name="upload_proposal"
                                        id="proposalMagang" required autofocus />
                                </div>
                                <div class="mb-3 col-md-12">
                                    <label for="suratRekomendasi" class="">Surat Rekomendasi Magang<span class="text-danger">*</label>
                                        <input type="file" class="form-control" name="upload_rekomendasi"
                                        id="suratRekomendasi" required autofocus />
                                </div>
                                <div class="mb-3 col-md-12">
                                    <label for="curriculumVitae" class="">Curriculum Vitae (CV)<span class="text-danger">*</label>
                                        <input type="file" class="form-control" name="upload_cv"
                                        id="curriculumVitae" required autofocus />
                                </div>
                                <div class="mb-3 col-md-12">
                                    <label for="transkripNilai" class="">Transkrip Nilai<span class="text-danger">*</label>
                                        <input type="file" class="form-control" name="upload_nilai"
                                        id="transkripNilai" required autofocus />
                                </div>
                                <div class="mb-3 col-md-12">
                                    <label for="portFolio" class="">Portfolio<span class="text-danger">*</label>
                                        <input type="file" class="form-control" name="upload_portfolio"
                                        id="portFolio" />
                                </div>

                                <div class="col-md-12">
                                    <button class="btn float-end" id="submit" type='button'
