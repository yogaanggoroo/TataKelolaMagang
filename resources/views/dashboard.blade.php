            ...
            <div class="row justify-content-between">
                <div class="d-flex flex-column text-lg-start pt-3">
                    <div class="hero-text pt-lg-5">
                        <h1 data-aos="zoom-in-up" class="txt-header col-lg-5">PROGRAM MAGANG PT PLN (PERSERO)</h1>
                        <p data-aos="zoom-in-up" class="txt-hero col-lg-6 pt-2">Suatu program belajar secara
        ...
        <div class="container h-100 text-black">
            <div class="d-flex">
                <div class="">
                    ...
                    <h3 data-aos="fade-right" class="text-black pt-3" style="font-size: 17px;">A. Kriteria Peserta Magang</h3>
                    <p data-aos="fade-right" class="pt-1" style="font-size: 15px; font-weight: 300;">Mahasiswa yang melakukan magang harus
                        memenuhi ketentuan sebagai berikut:
                    </p>
                    <div class="p-1">
                        <p data-aos="fade-right" style="font-size: 15px; font-weight: 300;">1. Sehat secara jasmani dan rohani. <br>
                    ...
                    <h3 data-aos="fade-right" class="text-black pt-3" style="font-size: 17px;">B. Persyaratan Administrasi</h3>

                    <div class="p-1">
                        <p data-aos="fade-right" style="font-size: 15px; font-weight: 300;">1. Surat Pengantar dari Universitas.</p>
                        <p data-aos="fade-right" style="font-size: 15px; font-weight: 300;">2. Proposal Magang yang berisikan :</p>
                        <div class="p-1">
                            <li data-aos="fade-right" style="font-size: 15px; font-weight: 300;">Keterangan data mahasiswa (Nama, NIM, Kontak
                                Pribadi, Fakultas/Program Studi/Jurusan, Semester)</li>
                            <li data-aos="fade-right" style="font-size: 15px; font-weight: 300;">Durasi dan periode magang</li>
                            <li data-aos="fade-right" style="font-size: 15px; font-weight: 300;">Maksud dan tujuan magang</li>
                            <li data-aos="fade-right" style="font-size: 15px; font-weight: 300;">Harapan atau target yang akan dicapai</li>
                            <li data-aos="fade-right" style="font-size: 15px; font-weight: 300;">Bidang pekerjaan yang diminati</li>
                        </div>
                        <p data-aos="fade-right" style="font-size: 15px; font-weight: 300;">3. Curriculum Vitae</p>
                    </div>
                </div>
