...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4" style="overflow-x-auto">
            ...
            <button wire:click="create()" class="bg-primary text-white font-bold py-2 px-4 rounded my-3">Tambah Laporan</button>
            ...
            <table class="min-w-full divide-y divide-gray-200 "  >
                <thead class="bg-gray-50 dark:bg-gray-600 dark:text-gray-200">
                    <tr class="bg-white-100">
                        ...
                        <th scope="col" class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-200 uppercase tracking-wider">LogBook</th>
