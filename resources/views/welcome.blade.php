...
<nav id="navbar" class="navbar navbar-expand-lg sticky-top" style="background-color: #0E4770">
    <div class="container">
        ...
        <!-- <div class="justify-content-end" id="navbarNav">
             @if (Route::has('login'))
                <div class="">
                    ...
                    @else
                        <a href="{{ route('login') }}" class="btn-user">Login</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="btn-user">Register</a>
                        @endif
                    @endauth
                </div>
            @endif
...
<body>
    <!-- ======= Hero Section ======= -->
    <section id="hero" class="vh-100 d-flex align-items-center hero-img">
        <div class="container text-center position-relative text-white">
            <h1 data-aos="zoom-in">APLIKASI TATA KELOLA MAGANG PT PLN (PERSERO)</h1>
            ...
            <div data-aos="zoom-in" class="pt-4">
                ...
                @if (Route::has('register'))
                <a href="{{ route('register') }}" data-aos="zoom-in" class="btn-registration m-1">Register</a>
                @endif
                @endauth
            </div>
            @endif
